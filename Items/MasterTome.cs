...
public class MasterTome : ModItem
{
	public override void SetStaticDefaults()
	{
		// DisplayName.SetDefault("Sorcerer's Tome");
		// Tooltip.SetDefault("Shoots a coil of powerful magic that slightly homes in on enemies\nInflicts Cleansing debuff");
	}
	...
	public override void SetDefaults()
	{
		...
		Item.noMelee = true;
		Item.autoReuse = true;
		Item.shoot = Mod.Find<ModProjectile>("MasterProj").Type;
	...
	public override void AddRecipes()
	{
		...
		recipe.AddIngredient(null, "SorcererTome");
		...
		recipe2.AddIngredient(null, "SorcererTome");
		recipe2.AddIngredient(null, "EnchantedBook");
		recipe2.AddIngredient(null, "MagicSoul", 15);
