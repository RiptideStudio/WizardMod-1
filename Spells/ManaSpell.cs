...
public class ManaSpell : ModItem
{
	...
	{
		// DisplayName.SetDefault("Lesser Mana Spell");
	...
	public override void SetDefaults()
	{
		...
		Item.value = 400;
		Item.shoot = Mod.Find<ModProjectile>("ManaSpellProj").Type;
		Item.shootSpeed = 8f;
		Item.autoReuse = true;
	}
	...
	public override bool Shoot(Player player, EntitySource_ItemUse_WithAmmo source, Vector2 position, Vector2 velocity, int type, int damage, float knockback)
	{
		...
		{
			Projectile.NewProjectile((IEntitySource)source, position, velocity, Mod.Find<ModProjectile>("ManaSpellProj").Type, damage, knockback, player.whoAmI, 0f, 0f);
		}
		if (this.shot == 3)
		{
