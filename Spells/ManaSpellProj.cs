...
public class ManaSpellProj : ModProjectile
{
	...
	public override void OnKill(int timeLeft)
	{
		...
		Projectile.NewProjectile(p.GetSource_ReleaseEntity(), Projectile.position, Projectile.velocity, Mod.Find<ModProjectile>("ManaLinger").Type, 0, 0f, p.whoAmI, 0f, 0f);
