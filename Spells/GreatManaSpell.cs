...
public class GreatManaSpell : ModItem
{
	private int splashHealAmount = 55;

	private int lingerHeal = 8;
	...
	{
		// DisplayName.SetDefault("Mana Spell");
	...
	public override void SetDefaults()
	{
		...
		Item.value = 800;
		Item.shoot = Mod.Find<ModProjectile>("GreatManaSpellProj").Type;
		Item.shootSpeed = 8f;
		Item.autoReuse = true;
	}
	...
	public override bool Shoot(Player player, EntitySource_ItemUse_WithAmmo source, Vector2 position, Vector2 velocity, int type, int damage, float knockback)
	{
		...
		{
			Projectile.NewProjectile((IEntitySource)source, position, velocity, Mod.Find<ModProjectile>("GreatManaSpellProj").Type, damage, knockback, player.whoAmI, 0f, 0f);
		}
		if (this.shot == 3)
		{
	...
	public override void AddRecipes()
	{
		...
		recipe.AddIngredient(null, "ManaSpell");
