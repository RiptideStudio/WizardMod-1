...
public class GreaterManaSpellProj : ModProjectile
{
	...
	public override void OnKill(int timeLeft)
	{
		...
		Projectile.NewProjectile(Projectile.GetSource_Death(), new Vector2(Projectile.position.X - 96f, Projectile.position.Y - 16f), new Vector2(0f, 0f), Mod.Find<ModProjectile>("GreaterManaLinger").Type, 0, 0f, p.whoAmI, 0f, 0f);
