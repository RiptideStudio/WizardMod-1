...
public class StormSenderProj : ModProjectile
{
	...
	public override void SetDefaults()
	{
		...
		Projectile.timeLeft = Main.rand.Next(40, 55);
		Projectile.light = 0f;
	...
	public override void AI()
	{
		...
		{
			Projectile.NewProjectile(Projectile.GetSource_Death(), Projectile.position, new Vector2(Main.rand.Next(-4, 4), Main.rand.Next(-4, 4)), Mod.Find<ModProjectile>("ThunderDustDamage").Type, Projectile.damage / 2, 0f, Main.myPlayer, 0f, 0f);
		}
		Projectile.friendly = true;
		...
		if (target)
		{
			...
			Projectile.velocity = (10f * Projectile.velocity + move) / 2f;
			this.AdjustMagnitude(ref Projectile.velocity);
		}
		this.time++;
