...
public class ReaperProj : ModProjectile
{
	...
	public override bool OnTileCollide(Vector2 oldVelocity)
	{
		...
		for (int i = 0; i < 5; i++)
		{
			...
			Projectile.NewProjectile(Projectile.GetSource_Death(), Projectile.position, new Vector2(projectilespeedX, projectilespeedY), Mod.Find<ModProjectile>("ShadowExplosion").Type, Projectile.damage, projectileknockBack, p.whoAmI, 0f, 0f);
		}
