...
public class CrimsonWaveProj : ModProjectile
{
	private int KB = 7;
	...
	public override void OnKill(int timeLeft)
	{
		...
		Projectile.NewProjectile(Projectile.GetSource_Death(), new Vector2(Projectile.position.X + 6f, Projectile.position.Y + 6f), new Vector2(0f, 0f), Mod.Find<ModProjectile>("CrimsonWave").Type, Projectile.damage, (float)this.KB, p.whoAmI, 0f, 0f);
	}
}
