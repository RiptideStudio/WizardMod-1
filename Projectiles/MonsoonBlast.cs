...
public class MonsoonBlast : ModProjectile
{
	...
	{
		// DisplayName.SetDefault("Huge blast");
	...
	public override void AI()
	{
		...
		{
			int dust2 = Dust.NewDust(new Vector2(Projectile.position.X + 17f + Projectile.velocity.X * 3f, Projectile.position.Y + Projectile.velocity.Y * 3f), 1, 1, 175);
			Main.dust[dust2].velocity *= 0.25f;
			Main.dust[dust2].scale = (float)Main.rand.Next(166, 195) * 0.013f;
			Main.dust[dust2].noGravity = true;
		}
	}
