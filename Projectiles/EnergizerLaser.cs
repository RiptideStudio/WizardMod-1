...
public class EnergizerLaser : ModProjectile
{
	...
	public override void OnKill(int timeLeft)
	{
		...
		{
			Projectile.NewProjectile(Projectile.GetSource_Death(), new Vector2(Projectile.position.X + 4f, Projectile.position.Y + 4f), new Vector2(-1.5f + (float)i, -1.5f), Mod.Find<ModProjectile>("EnergizerLightning").Type, Projectile.damage / 2, Projectile.knockBack, Main.myPlayer, 0f, 0f);
		}
		for (int j = 0; j < 30; j++)
		{
