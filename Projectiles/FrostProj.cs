	...
	public override void AI()
	{
		if (Main.rand.Next(1) == 0)
		{
			for (int i = 0; i < 2; i++)
			{
				...
				Main.dust[dust].scale = (float)Main.rand.Next(60, 175) * 0.013f;
				Main.dust[dust].noGravity = true;
				int dust2 = Dust.NewDust(position, 1, 1, 180);
				Main.dust[dust2].velocity *= 0.6f;
				Main.dust[dust2].scale = (float)Main.rand.Next(60, 175) * 0.013f;
