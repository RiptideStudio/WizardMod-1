...
public class BatOrbProj : ModProjectile
{
	...
	{
		target.AddBuff(Mod.Find<ModBuff>("RottenDebuff").Type, 60);
	}

	public override void AI()
	{
		int dust2 = Dust.NewDust(Projectile.position, Projectile.width, Projectile.height, 14);
	...
	public override void OnKill(int timeLeft)
	{
		...
		Projectile.NewProjectile(Projectile.GetSource_Death(), new Vector2(Projectile.position.X - 96f, Projectile.position.Y - 236f), new Vector2(5f, 10f), Mod.Find<ModProjectile>("BatProj").Type, Projectile.damage, Projectile.knockBack, Main.myPlayer, 0f, 0f);
		for (int num371 = 0; num371 < 3; num371++)
		{
			...
			Main.dust[num372].velocity *= 1.5f;
		}
