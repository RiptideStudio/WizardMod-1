...
public class EnergizerLightning : ModProjectile
{
	...
	public override void AI()
	{
		...
		if (Main.rand.Next(1) == 0)
		{
			...
			Main.dust[dust].scale = (float)Main.rand.Next(25, 55) * 0.013f;
			Main.dust[dust].noGravity = true;
			int dust2 = Dust.NewDust(position, 1, 1, 75);
			Main.dust[dust2].velocity *= 0.2f;
			Main.dust[dust2].scale = (float)Main.rand.Next(25, 55) * 0.013f;
