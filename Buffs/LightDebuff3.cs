...
public class LightDebuff3 : ModBuff
{
	private int time;
	...
	public override void Update(NPC npc, ref int buffIndex)
	{
		...
		if (this.time % 60 == 0)
		{
			...
			Projectile.NewProjectile(player.GetSource_DropAsItem(), new Vector2(npc.position.X + 12f, npc.position.Y + 2f), new Vector2(0f, 0f), Mod.Find<ModProjectile>("HealingOrb3").Type, 0, 0f, player.whoAmI, 0f, 0f);
		}
